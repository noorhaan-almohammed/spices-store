...
$alt_lang_url = '../ar/products.php';

// Enhanced products data with attributes
$products = [
    [
        'id' => 1,
        'name' => 'Narcissus',
...
<section class="filters-section">
    <div class="filters-container">
        ...
        <div class="category-filter">
            <a href="?category=all" class="filter-btn <?= $category_filter === 'all' ? 'active' : '' ?>">All</a>
            ...
            <?php foreach ($filtered_products as $product): ?>
                <div class="product-card" onclick="window.location.href='product-details.php?id=<?= $product['id'] ?>'">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price"><?= htmlspecialchars($product['price_per_kg']) ?>/kg</div>
